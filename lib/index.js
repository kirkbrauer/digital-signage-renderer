    ...
    RenderWidget.prototype.render = function () {
        switch (this.props.widget.type) {
            case WidgetType.AUTO_SCROLL: {
                return React.createElement(AutoScrollWidget, { widget: this.props.widget }, this.props.children || this.renderChildWidgets());
            }
            case WidgetType.IMAGE: {
                return React.createElement(ImageWidget, { widget: this.props.widget });
            }
            case WidgetType.GROUP: {
                return React.createElement(GroupWidget, { widget: this.props.widget }, this.props.children || this.renderChildWidgets());
            }
